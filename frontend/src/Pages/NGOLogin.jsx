NGOLogin.jsx                                                                                                                                                                                             // File: pages/NGOLogin.jsx
          ...
          <div className="row justify-content-center">
            <div className="col-lg-6 col-md-8">
              <div className="text-center mb-4">
                <i className="bi bi-people-fill text-success display-3 mb-3"></i>
                <h2 className="text-success fw-bold">NGO Partner Login</h2>
                <p className="text-muted lead">Access your project management dashboard</p>
              </div>
